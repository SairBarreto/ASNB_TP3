...
void empezar_a_rescatar(string animales_perdidos, string animales_rescatados, Lista<Animal>* lista_animales_a_rescatar)
{
    int salir = 1;
        ...
        if (autito.se_puede_viajar(gasolina_necesaria) && respuesta =="s")
            {
                ...
                //    arbol_animales -> insertar(especie_inicial_a_string(lista_animales_a_rescatar -> obtener_especie()), lista_animales_a_rescatar -> obtener_nombre());
